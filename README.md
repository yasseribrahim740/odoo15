...
``` bash
curl -s https://github.com/yasseribrahim740/odoo15.git/master/run.sh | sudo bash -s odoo-one 10015 20015
```
...
``` bash
curl -s https://github.com/yasseribrahim740/odoo15.git/master/run.sh | sudo bash -s odoo-two 11015 21015
```
...
``` sh
$ git clone https://github.com/yasseribrahim740/odoo15.git
...
* Default database password (**admin_passwd**) is `l1N746hawOrI`, please change it @ [etc/odoo.conf#L60](/etc/odoo.conf#L60)
